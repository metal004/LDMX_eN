...
myfile = TFile("pi0_maps_nominal.root","RECREATE")
f = TFile("1pi0_5Apr.root")
...
h_e_old_ph = TH1F("h_e_old_ph","#pi^{0} Photon Energy [previous]",40,0,2500)
h_e_total_ph_l = TH1F("h_e_total_ph_l","",40,0,2500)
h_e_total_ph_sl = TH1F("h_e_total_ph_sl","",40,0,2500)
h_e_total_ph_old = TH1F("h_e_total_ph_old","",40,0,2500)
...
h_e_old_pi0 = TH1F("h_e_old_pi0","#pi^{0} Energy [previous]",40,0,2500)
h_e_total_pi0 = TH1F("h_e_total_pi0","",40,0,2500)
h_e_sum_pi0 = TH1F("h_e_sum_pi0","",40,0,2500)
h_e_sum_pi0_dist = TH1F("h_e_sum_pi0_dist","",40,0,2500)
...
h_thz_old_ph = TH1F("h_thz_old_ph","#pi^{0} Energy [previous]",50,0,100)
h_thz_total_ph_l = TH1F("h_thz_total_ph_l","",50,0,100)
h_thz_total_ph_sl = TH1F("h_thz_total_ph_sl","",50,0,100)
h_thz_total_ph_old = TH1F("h_thz_total_ph_sl","",50,0,100)
...
h_thz_old_pi0 = TH1F("h_thz_old_pi0","#pi^{0} Angle [previous]",50,0,100)
h_thz_total_pi0 = TH1F("h_thz_total_pi0","",50,0,100)
h_thz_sum_pi0 = TH1F("h_thz_sum_pi0","",50,0,100)
h_thz_sum_pi0_dist = TH1F("h_thz_sum_pi0_dist","",50,0,100)
...
h_old_2d_ph = TH2F("h_old_2d_ph","",40,0,4000,40,0,100)
...
h_old_2d_pi0 = TH2F("h_old_2d_pi0","#pi^{0} Efficiency Map (#pi^{0} kinematics) [Previous]",40,0,4000,40,0,100)
...
for entryNum in range(0,ana_tree.GetEntries()):
    ...
    if(len(ph_e)>ph1_idx[0] and len(ph_h)>ph1_idx[0] and len(ph_e)>ph2_idx[0] and len(ph_h)>ph2_idx[0]):
        ...
        h_e_total_ph_old.Fill(p_e_true[ph1_idx[0]])
        h_thz_total_ph_old.Fill(p_thetaz[ph1_idx[0]]*180/3.1415)
       ...
       # if(ph_e[ph1_idx[0]]>0 and ph_h[ph1_idx[0]]==0 and ph_e[ph2_idx[0]]>0 and ph_h[ph2_idx[0]]==0):
            if(p_e_true[ph1_idx[0]]>60 and p_e_true[ph2_idx[0]]>60 and p_thetaz[ph1_idx[0]]<40*3.14/180 and p_thetaz[ph2_idx[0]]<40*3.14/180):
                h_e_old_ph.Fill(p_e_true[ph1_idx[0]])
                h_e_old_pi0.Fill(p_e_true[pi0_idx[0]])
                h_thz_old_ph.Fill(p_thetaz[ph1_idx[0]]*180/3.1415)
                h_thz_old_pi0.Fill(p_thetaz[pi0_idx[0]]*180/3.1415)
                h_old_2d_ph.Fill(p_e_true[ph1_idx[0]],p_thetaz[ph1_idx[0]]*180/3.1415)
                h_old_2d_pi0.Fill(p_e_true[pi0_idx[0]],p_thetaz[pi0_idx[0]]*180/3.1415)
        ...
        # hh case
        if(ph_h[ph1_idx[0]]>1.5 and ph_e_lw[ph1_idx[0]]==0 and ph_h[ph2_idx[0]]>1.5 and ph_e_lw[ph2_idx[0]]==0):
        ...
        # eh case pi0
        if((ph_e_lw[ph1_idx[0]]>0 and ph_h[ph1_idx[0]]==0 and ph_h[ph2_idx[0]]>1.5 and ph_e_lw[ph2_idx[0]]==0) or (ph_e_lw[ph2_idx[0]]>0 and ph_h[ph2_idx[0]]==0 and ph_h[ph1_idx[0]]>1.5 and ph_e_lw[ph1_idx[0]]==0)):
...
# print entries
#print(f'num entries in leading ph is {h_e_sum_ph_l.GetEntries()}')
#print(f'num entries in sub-leading ph is {h_e_sum_ph_sl.GetEntries()}')
n_l_ee = h_ee_e_ph_l.GetEntries()
n_l_hh = h_hh_e_ph_l.GetEntries()
n_l_eh = h_eh_e_ph_l.GetEntries()
n_l_tot = n_l_ee+n_l_hh+n_l_eh
print(f'num entries in leading ph is {n_l_tot}')
n_sl_ee = h_ee_e_ph_sl.GetEntries()
n_sl_hh = h_hh_e_ph_sl.GetEntries()
n_sl_eh = h_eh_e_ph_sl.GetEntries()
n_sl_tot = n_sl_ee+n_sl_hh+n_sl_eh
print(f'num entries in sub-leading ph is {n_sl_tot}')
print(f'num entries in leading ph denom is {h_e_total_ph_l.GetEntries()}')
print(f'num entries in sub-leading ph denom is {h_e_total_ph_sl.GetEntries()}')
...
#h_e_sum_ph_l_dist = h_e_sum_ph_l.Clone()
#h_e_sum_ph_sl_dist = h_e_sum_ph_sl.Clone()
...
h_e_old_ph.Divide(h_e_total_ph_old)

h_ee_e_ph_l.Divide(h_e_total_ph_l)
h_hh_e_ph_l.Divide(h_e_total_ph_l)
h_eh_e_ph_l.Divide(h_e_total_ph_l)

h_e_total_ph_l.Scale(1./h_e_total_ph_l.Integral())
h_e_total_ph_sl.Scale(1./h_e_total_ph_sl.Integral())
...
h_e_total_ph_l.SetLineColor(1)
h_e_total_ph_l.SetLineStyle(2)
h_e_total_ph_sl.SetLineColor(4)
h_e_total_ph_sl.SetLineStyle(2)
h_e_old_ph.SetLineColor(2)
h_e_sum_ph_l.GetXaxis().SetTitle("Photon Energy")
h_e_sum_ph_l.GetYaxis().SetRangeUser(0,0.6)
h_e_sum_ph_l.SetStats(0)
h_e_sum_ph_l.Draw("hist")
h_e_sum_ph_sl.Draw("hist same")
h_e_old_ph.Draw("hist same")
h_e_total_ph_l.Draw("hist same")
h_e_total_ph_sl.Draw("hist same")
...
l1.AddEntry(h_e_old_ph,"Previous efficiency")
l1.AddEntry(h_e_total_ph_l,"#splitline{Leading photon distribution}{(normalized to 1)}")
l1.AddEntry(h_e_total_ph_sl,"#splitline{Sub-leading photon distribution}{(normalized to 1)}")
...
#h_e_sum_pi0_dist = h_e_sum_pi0.Clone()
#h_e_sum_pi0_dist.Scale(1./h_e_sum_pi0_dist.Integral())

h_e_sum_pi0.Divide(h_e_total_pi0)
h_e_old_pi0.Divide(h_e_total_pi0)

h_ee_e_pi0.Divide(h_e_total_pi0)
h_hh_e_pi0.Divide(h_e_total_pi0)
h_eh_e_pi0.Divide(h_e_total_pi0)

h_e_total_pi0.Scale(1./h_e_total_pi0.Integral())

c2 = TCanvas("c2")
h_e_sum_pi0.SetLineColor(1)
h_e_old_pi0.SetLineColor(2)
h_e_sum_pi0.GetXaxis().SetTitle("#pi^{0} Energy")
h_e_sum_pi0.GetYaxis().SetRangeUser(0,0.5)
h_e_sum_pi0.SetStats(0)
h_e_total_pi0.SetLineColor(1)
h_e_total_pi0.SetLineStyle(2)
#h_e_sum_pi0_dist.SetLineColor(1)
#h_e_sum_pi0_dist.SetLineStyle(2)
h_e_sum_pi0.Draw("hist")
h_e_old_pi0.Draw("hist same")
...
#h_thz_sum_ph_l_dist = h_thz_sum_ph_l.Clone()
#h_thz_sum_ph_sl_dist = h_thz_sum_ph_sl.Clone()
...
h_thz_old_ph.Divide(h_thz_total_ph_old)

h_thz_total_ph_l.Scale(1./h_thz_total_ph_l.Integral())
h_thz_total_ph_sl.Scale(1./h_thz_total_ph_sl.Integral())

c3 = TCanvas("c3")
h_thz_sum_ph_l.SetLineColor(1)
h_thz_total_ph_l.SetLineColor(1)
h_thz_total_ph_l.SetLineStyle(2)
h_thz_sum_ph_sl.SetLineColor(4)
h_thz_total_ph_sl.SetLineColor(4)
h_thz_total_ph_sl.SetLineStyle(2)
h_thz_old_ph.SetLineColor(2)
h_thz_sum_ph_l.GetXaxis().SetTitle("Photon Angle [degrees]")
h_thz_sum_ph_l.GetYaxis().SetRangeUser(0,0.5)
h_thz_sum_ph_l.SetStats(0)
#h_thz_old_ph.Draw("hist")
h_thz_sum_ph_l.Draw("hist")
h_thz_sum_ph_sl.Draw("hist same")
h_thz_old_ph.Draw("hist same")
h_thz_total_ph_l.Draw("hist same")
h_thz_total_ph_sl.Draw("hist same")
...
l2.AddEntry(h_thz_old_ph,"Previous Efficiency")
l2.AddEntry(h_thz_total_ph_l,"#splitline{Leading photon distribution}{(normalized to 1)}")
l2.AddEntry(h_thz_total_ph_sl,"#splitline{Sub-leading photon distribution}{(normalized to 1)}")
#l2.Draw("hist same")
...
#h_thz_sum_pi0_dist = h_thz_sum_pi0.Clone()
#h_thz_sum_pi0_dist.Scale(1./h_thz_sum_pi0_dist.Integral())

h_thz_sum_pi0.Divide(h_thz_total_pi0)
h_thz_old_pi0.Divide(h_thz_total_pi0)

h_ee_thz_pi0.Divide(h_thz_total_pi0)
h_hh_thz_pi0.Divide(h_thz_total_pi0)
h_eh_thz_pi0.Divide(h_thz_total_pi0)

h_thz_total_pi0.Scale(1./h_thz_total_pi0.Integral())

c4 = TCanvas("c4")
h_thz_sum_pi0.SetLineColor(1)
h_thz_old_pi0.SetLineColor(2)
h_thz_sum_pi0.GetXaxis().SetTitle("#pi^{0} Angle [degrees]")
h_thz_sum_pi0.GetYaxis().SetRangeUser(0,0.5)
h_thz_sum_pi0.SetStats(0)
h_thz_total_pi0.SetLineColor(1)
h_thz_total_pi0.SetLineStyle(2)
h_thz_sum_pi0.Draw("hist")
h_thz_old_pi0.Draw("hist same")
...
#h_old_2d_ph.Divide(h_total_2d_ph)
#h_old_2d_pi0.Divide(h_total_2d_pi0)
